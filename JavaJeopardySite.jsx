  ...
  categories: [
    ...
    },
    {
      ...
      clues: [
        ...
        { value: 300, code: `public class Counter {\n    private static int count = 0;\n    private int id;\n    public Counter() {\n        count++;\n        id = count;\n    }\n    public int getId() {\n        return id;\n    }\n    public static int getCount() {\n        return count;\n    }\n}\n\nCounter a = new Counter();\nCounter b = new Counter();\nCounter c = new Counter();`, question: "What is the value returned by Counter.getCount() after this code executes?", answer: "3" },
    ...
    },
    {
      ...
      clues: [
        ...
        {
          value: 600,
          code: `int[][] grid = new int[2][8];`,
          question: "What is the value of `grid[1].length`?",
          answer: "8",
        },
      ],
    },
    {
      ...
      clues: [
        ...
        {
          value: 600,
          code: `// Wrapper type for a primitive`,
          question: "What is the wrapper class name for the `boolean` primitive type?",
          answer: "Boolean",
        },
      ],
    },
